...
(define-syntax-rule (collection-take s n) (stream-take s n))
...
(define-syntax-rule (collection-filter crit s) (stream-filter crit s))

(define-syntax-rule (collection-map func s) (stream-map func s))

(define-syntax-rule (collection-fold func acc s) (stream-fold func acc s))